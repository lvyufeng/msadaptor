...
class autocast:
    ...
    def __enter__(self):
        self.prev_fastdtype = torch.get_autocast_dtype(self.device_type)
        torch.set_autocast_dtype(self.device_type, self.dtype)
    ...
    def __exit__(self, exc_type: Any, exc_val: Any, exc_tb: Any):  # type: ignore[override]
        pop_amp_strategy()
        torch.set_autocast_dtype(self.device_type, self.prev_fastdtype)
        return False
